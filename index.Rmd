...
Sin embargo, la perspectiva sobre los salarios cambia si es que nos acercamos a los postulados de la teoría crítica del pensamiento económico clásico. En ese sentido, Marx entiende a los salarios como "la parte de la mercancía ya existente, con la que el capitalista compra una determinada cantidad de fuerza de trabajo productiva [...] La fuerza de trabajo es, pues, una mercancía que su propietario, el obrero asalariado, vende al capital. ¿Para qué la vende? Para vivir" (Marx 1849:3). El salario no sería el resultado de la oferta y la demanda sobre el precio del trabajo del trabajador, sino la mercancía que el capitalista intercambia con el trabajador. Este intercambio es formalmente libre en tanto es el trabajador quien pone a la venta su fuerza de trabajo. Sin embargo, la libertad formal termina en tanto la obligación surge de la necesidad de vivir del obrero, situacion relacionada con la acumulación originaria: el obrero no es dueño de los medios de producción a partir de un proceso histórico violento de arrebato de tierras, medios de vida y marginación social. 
...
Esto tiene una última implicancia, el trabajador debe recibir lo necesario para poder consumir las mercancías que otros trabajadores producen para vivir, pero más importante aún, para vovler a trabajar al día siguiente. 

Los límites de ambas perspectivas económcias pueden encontrarse en su aplicación en el ambito geográfico en el que se aplican. Hayek escribía muchas veces desde la realidad anglosajona europea. En ella, se desarrolló un Estado de bienestar que gozó por mucho tiempo de popularidad y resutlados aceptables para su población, pero que decae en buena medida por factores externos como la crisis del petróleo. Tal situación no se ha dado en América Latina y hoy los sindicatos tienen poco peso en el ámbito político. Al mismo tiempo, existen países como Perú que tienen una economía informal mucho más grande que la formal y en la que la ausencia del Estado no ha traído el progreso que las teorías más cercanas a la libertad empresarial auguraron. 

Por su lado, Marx encontró su límite al dejar de lado las realidades de los países menos industrializados y de mayor peso campesino. Si bien Marx y Engels acusaron la desigualdad interna dentro del propio proletariado en términos de género y el impacto sobre las muejres, su desarollo teórico quedó en deuda pues no conforma una variable con un desarrollo igual de profundo en su teoría. 

Por ello, exploramos distintos datos en países alrededor del mundo para acercarnos a la presición sobre la naturaleza real del salario. Se sostiene que los factores económicos y sociales como inflación, brecha de pobreza; salario mínimo; indice costo de vida; la tasa de Alfabetización, el promedio de horas semanales y las mujeres que trabajan, son relevantes para esta investigación. 
...
Nos interesa anotar que un indicador relacionado con la educación (alfabetización) está incrementnado en 19.35 dolares el promedio salarial. Esto podría estar relacionado con la mano de obra especializada, la cual puede estar incrementando el costo de mano de obra pero, al mismo tiempo, incrementando las desigualdades sociales pues ese aumento se da solo en esas personas. 

Sabemos que la produción actual se sostiene con un alto grado de división del trabajo. Para Marx, este concepto tenía mucha importancia para el análisis del modo de producción capitalista. El autor señalaba que la división del trabajo conduce dentro de las naciones a la separación del trabajo industrial y del campo, separación ciudad/campo y a la oposición de sus intereses. 

El desarrollo ulterior lleva a la separación del trabajo industrial del comercial. Además, la división del trabajo trae consigo la creación de distintas secciones determinadas por la rama en la que trabajan y cuya posición respecto a otras depende de la manera en cómo se da el trabajo industrial, comercial y agrícola (estamentos, clases, esclavitud) (Marx y Engels 1845: 41). En consecuencia, “las relaciones personales se convierten necesariamente en relaciones de clase y se fijan como tales” (Marx y Engels 1845: 42). En esa separación de la calidad y trabajo de la mano obrera, la mano de obra calificada estaría ganando más que la fuerza de trabajo bruta del proletario carente de educación. Para Hyek, esta diferencia se explicaría por la competencia en el mercado. Para Marx, esta diferencia es consecuencia de la división del trabajo y la consecuente especialización que se requiere y escasea en relación a la masa no educada, personas que solo cuentan con sus brazos y su fuerza para vender.  
...
En el gráfico de correlación, "horassemanas" y "explotación" son las que están más correlacionadas. Mientras que un ahace referncia al promedio del tiempo de trabajo, la otra hace referencia a las horas trabajadas fuera de lo permtiido por la ley. 
...
- Asimismo, es interesante encontrar que variables como Horas semanales de trabajo y Explotación laboral son las que oarecen aportar menos en comparación a las otras varbiales trabajadas

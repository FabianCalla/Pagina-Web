...
El promeduo salarial del pais es una variable interesante para estudiar debido a que a través de esta se puede conocer más acerca de la vida economica y social de un país. (agregan sus partes)
Haciendo uso de varibles independiente se ha buscado conocer cuáles son las que mana influyen en el Salario Promedio a nivel mundial, se ha logrado inferir que variables como el salario mínimo, tasa de alfabetización, mujeres que trabajan son relevantes oara que se calcule el promedio salarial de un país, 
Asi mismo es interesante encontrar que variables como Horas semanales de trabajo y Explotación laboral son las que oarecen aportar menos en comparación a las otras varbiales trabajadas. 
